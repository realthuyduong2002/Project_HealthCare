...
public interface AppointmentService {
    ...
    @DELETE("patient/appointments/cancel/{PatientID}/{AppointmentID}")
    Call<Appointment> cancelAppointment(@Path("PatientID") int PatientID, @Path("AppointmentID") int AppointmentID);
}
